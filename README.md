...
一个离线使用的 Android 待办提醒软件，支持 Android 8.0 及以上。
...
- 未完成事项右侧圆圈勾选完成。日程按事项开始日期归属，完成后仍留在当天列表底部。

- 独立课程表：和市面上其它课程表软件功能类似。轻量无广告，UI美观。
- 课程表提供查看、编辑、作业三种模式。课程作业自动加入待办，并默认在下次上课前最近的周六 12:00 提醒；若周末已过则改为上课前一天 12:00，提醒可继续增改。（防止学生忘记作业，错过作业提交时间，追悔莫及）
