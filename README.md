...
- 月历与日程面板点击日期查看当天全部安排；未完成事项在前，已完成事项自动沉底并变灰。拖动分隔条上拉收为周历、下拉展开月历，也可点击切换。支持上一月／周、下一月／周和回到今天。
- 创建和编辑时可选轻重缓急：红色“重要且紧急”、橙色“不重要但紧急”、蓝色“重要不紧急”、绿色“不重要不紧急”；事项显示颜色条和文字分类，月历显示对应色点。旧数据默认绿色分类，可编辑调整。
- 主页放大“轻待办”标题，移除原标语；未完成事项右侧圆圈勾选完成。日程按事项开始日期归属，完成后仍留在当天列表底部。

- 新建、编辑、删除事项和标记完成；已完成事项可以在详情页改为未完成。
